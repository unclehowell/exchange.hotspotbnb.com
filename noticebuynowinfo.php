...
if(isset($_REQUEST['noticebuymoney']) && isset($_REQUEST['noticebuyamountshares']) &&  isset($_REQUEST['noticebuyuserid']) && isset($_REQUEST['actions']) &&isset($_REQUEST['noticetotalbuyprice']) && isset($_REQUEST['noticetotalbuypricefixed'])){
...
<div class="" style=" margin-bottom:15px;">
 <?php include("sidebar.php");?> 
  <div class="col-md-9 pull-right" style="width:74%">
 <?php 
 global $wpsh;
...
<table border="1">
	<tr>
		...
		<td>      
                        <?php   echo $noofshare = $_REQUEST['noticebuymoney'];  ?>

			<input type="hidden" id="noofshare" name="noofshare" value="<?php echo $noofshare=$_REQUEST['noticebuymoney']; ?>" />
		</td>
	</tr>
	<tr>
		<td>Price of Shares (in <?php echo $_REQUEST['noticebuycurrency']; ?>)</td>
		<td>  

                        <?php echo $priceofsharesincurrency =  $totalprice = $_REQUEST['noticebuyequity']; ?>

			<input type="hidden" id="totalprice" name="totalprice" value="<?php echo $totalprice=$_REQUEST['noticebuyequity']; ?>" />
	...
	<tr>
		  <td>
                      ...
                      Price of Shares inc. <?php echo $getsharebuyfee = $wpsh->getsharebuyfee(); ?>% Fee (in <?php echo $_REQUEST['noticebuycurrency']; ?>)</td>
	...
	<tr>
		...
		<td>
                       ...
                       <?php 
                        ...
                        if( $_REQUEST['noticebuycurrency'] == 'BTC'){
                                           ...
                                           $api = "https://blockchain.info/tobtc?currency=".$_REQUEST['noticebuycurrency']."&value=".$totalpricewithfee;
...
<div class="panel-footer text-center" style="display: inline-block;    margin-top: 30px; border:none">
                     ...
                     <form action="process.php" method="post" />
                        ...
                        if( $_REQUEST['noticebuycurrency'] == 'BTC'){
                                           ...
                                           $api = "https://blockchain.info/tobtc?currency=".$_REQUEST['noticebuycurrency']."&value=".$buycommission;
                       ...
                       ?>">
                            ...
                            <input type="hidden" id="noticefinalcheckout"  name="noticefinalcheckout" value="noticefinalcheckout">

                            <input type="submit" id="noticebuyshares" class="btn btn-info" value="Check Out">

                        <input type="hidden"  id="salesharessaleid" name="salesharessaleid" value="<?php echo $_REQUEST[salesharessaleid]; ?>"  >
