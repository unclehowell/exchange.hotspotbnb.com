...
if(isset($_REQUEST['sellmoney']) && isset($_REQUEST['sellamountshares']) &&  isset($_REQUEST['selluserid']) && isset($_REQUEST['actions']) &&isset($_REQUEST['totalsellprice']) && isset($_REQUEST['totalsellpricefixed'])){
...
<h2>Shares Sell Information</h2>
<form id="paynow" name="paynow" action="process.php" method="post">
<table border="1">
	<tr>
		<td>No. of Share to Sell</td>
		<td>      
                        <?php   echo $noofshare = $_REQUEST['sellmoney'];  ?>

			<input type="hidden" id="noofshare" name="noofshare" value="<?php echo $noofshare=$_REQUEST['sellmoney']; ?>" />
		</td>
	</tr>
	<tr>
		<td>Price of Shares (in <?php echo $_REQUEST['sellcurrency']; ?>)</td>
		<td>  

                        <?php echo $priceofsharesincurrency =  $totalprice = $_REQUEST['sellequity']; ?>

			<input type="hidden" id="totalprice" name="totalprice" value="<?php echo $totalprice=$_REQUEST['sellequity']; ?>" />
	...
	<tr>
		  <td>
                      ...
                      Price of Shares inc. <?php echo $getsharesellfee = $wpsh->getsharesellfee(); ?>% Fee (in <?php echo $_REQUEST['sellcurrency']; ?>)</td>

		 <td> 

                         <?php 

                                $fee = $sellcommission = (($totalprice*($getsharesellfee))/100); 

                                $totalpricewithfee =  $totalprice-$sellcommission;
	...
	<tr>
		<td>Shares Sell From Bitcoin Address </td>
		<td>
		...
		<td>
                       ...
                       <?php 
                        ...
                        if( $_REQUEST['sellcurrency'] == 'BTC'){
                                           ...
                                           $api = "https://blockchain.info/tobtc?currency=".$_REQUEST['sellcurrency']."&value=".$totalpricewithfee;
...
<div class="panel-footer text-center" style="display:inline-block; margin-top:30px; border:none">
                     ...
                     <form action="process.php" method="post" />
                        ...
                        if( $_REQUEST['sellcurrency'] == 'BTC'){
                                           ...
                                           $totalpriceonlywithfee =  $sellcommission;
                                           ...
                                           $api = "https://blockchain.info/tobtc?currency=".$_REQUEST['sellcurrency']."&value=".$sellcommission;
                       ...
                       ?>">
                            ...
                            <input type="hidden" id="finalsellout"  name="finalsellout" value="finalsellout">

                            <input type="submit" id="sellshares" class="btn btn-info" value="Post to sellers list !">
